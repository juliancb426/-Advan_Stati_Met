...
date: "12/Oct/2019"
author: "Andrés Franco, Julían Castelblanco y Edgar Alirio Rodríguez"
output:
...
dfX$id<-NULL
dfX %>% select(x10,x13,x20,x23,x25,x31)->dfX
y_send <-lm_bma %>% predict(tail(dfX,25))
y_send$y<-y_send
write.csv(y_send$y,"C:/Users/User/Desktop/MAESTRIA/SEMESTRE_II/EC1209 - MÉTODOS ESTADÍSTICOS AVANZADOS EN CIENCIAS DE LOS DATOS/y_continua.csv", row.names = FALSE)
```